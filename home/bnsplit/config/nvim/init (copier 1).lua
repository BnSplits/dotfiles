...
-- Decrease mapped sequence wait time , Displays wich-key popup sooner
...
-- Minimal number of screen lines to kepp above and below the cursor
    ...
    { -- Useful plugin to show you pending keybinds.
      ...
      config = function() -- This is the function that runs, AFTER loading
        require("which-key").setup({
          icons = {
            breadcrumb = "»", -- symbole utilisé dans la ligne de statut
            separator = "➜", -- symbole utilisé entre une touche et son explication
            group = "", -- symbole préfixé aux noms de groupe
            mappings = false,
          },
        })
